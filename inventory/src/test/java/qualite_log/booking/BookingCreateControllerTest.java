...
public class BookingCreateControllerTest extends FxRobot {

    @Start
    public void start(Stage stage) throws Exception {
        configureData();
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/qualite_log/BookingCreateFrame.fxml"));
    ...
    void testSuccessfulBookingCreation() {
        ...
        // Vérifier que le matériel est emprunté
        ...
        // Le matériel doit exister dans la liste des emprunts
        assertTrue(bookingExists, "Le matériel devrait être listé dans le TableView des emprunts.");
    }
    ...
    void testNoReferenceSelection() {
        ...
        from(dialogPane).lookup((Text t) -> t.getText().startsWith("Aucun équipement sélectionné."));
