...
public class DataImportTest {
    ...
    //     EquipmentType equipT = new EquipmentType("laptops");
    ...
    //     EquipmentType equipT = new EquipmentType("laptops");
    //     dataPreImport.addEquipmentTypes(equipT);
    //     Equipment equip = new Equipment("LAP-176", "Asus Tuf", "QAIJP", equipT);
    //     User user = new User("jhon", "doe", "jhon.doe@etu.univ-tours.fr");
    //     dataPreImport.addUsers(user);
    //     dataPreImport.addBookings(new Booking(user, equip, LocalDate.of(2024, 01, 10),  LocalDate.of(2024, 01, 15))); 

    //     dataPrint(dataPreImport);

    //     DataWriter.extract(dataPreImport);
    
    //     dataPostImport = DataReader.insert();
        
    //     dataPrint(dataPostImport);
    // }

    // private static void dataPrint(Data data) {
    ...
    //     for (EquipmentType a : data.getEquipmentTypes()) {
    //         System.out.println(a.toString());
    //     }

    //     for (Equipment a : data.getEquipments()) {
    //         System.out.println(a.toString());
    //     }

    //     for (Booking a : data.getBookings()) {
    //         System.out.println(a.toString());
    //     }
    // }
}
